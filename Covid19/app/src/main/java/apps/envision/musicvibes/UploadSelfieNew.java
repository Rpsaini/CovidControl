...
//
//public class UploadSelfieNew extends AppCompatActivity {
//
...
//        setContentView(R.layout.activity_upload_selfie_new);
//        try {
//
//
...
//
//                        UploadSelfieNew.UploadVideo uv = new  UploadVideo(path, "selfie");
//                        uv.execute();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//            super.onPreExecute();
//            progressdlg = new ProgressDialog(UploadSelfieNew.this);
...
//            final String url1 = imp.reterivePrefrence(UploadSelfieNew.this, "url") + url;
//
...
//
//
//                                Toast.makeText(UploadSelfieNew.this,"Selfie Image Uploaded successfully",Toast.LENGTH_LONG).show();
//
//
//                            } catch (Exception e) {
//                                e.printStackTrace();
...
//
//                            Toast.makeText(UploadSelfieNew.this,"Selfie not Uploaded !",Toast.LENGTH_LONG).show();
//                            progressdlg.dismiss();
//
//                        }
//                    }) {
...
//
//
//            RequestQueue requestQueue = Volley.newRequestQueue(UploadSelfieNew.this);
...
//        protected void onPreExecute() {
//            super.onPreExecute();
//            uploading = ProgressDialog.show(UploadSelfieNew.this, "Uploading....", "Please wait...", false, false);
//        }
//
//        @Override
...
//                {
//                    Toast.makeText(UploadSelfieNew.this,"This file is not supported.Please select another image",Toast.LENGTH_LONG).show();
//
//                }
//                else
//                {
...
//                                    Toast.makeText(UploadSelfieNew.this,obj.getString("message"),Toast.LENGTH_LONG).show();
...
//            Upload u = new Upload();
//          //  String msg = u.uploadVideo(path1, imageType1,UploadSelfieNew.this,mobileNumber);
//
