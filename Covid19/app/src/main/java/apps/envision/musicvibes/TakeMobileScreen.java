...
//
//public class TakeMobileScreen extends AppCompatActivity {
...
//        setContentView(R.layout.activity_take_mobile_screen);
...
//
//                new ServerHandler().sendToServer(TakeMobileScreen.this, "login", m, 0, new CallBack() {
//                    @Override
...
//
//
//                                Intent i=new Intent(TakeMobileScreen.this,VerifyOtpScreen.class);
...
//                            else
//                            {
//                                Toast.makeText(TakeMobileScreen.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
//                            }
//
//                        }
//                        catch (Exception e)
