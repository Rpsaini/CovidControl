...
//        setContentView(R.layout.activity_mobile_number_screen);
...
//
//                new ServerHandler().sendToServer(MobileNumberScreen.this, "login", m, 0, new CallBack() {
//                    @Override
...
//
//
//                                Intent i=new Intent(MobileNumberScreen.this,VerifyOtpScreen.class);
...
//                            else
//                            {
//                                Toast.makeText(MobileNumberScreen.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
//                            }
//
//                        }
//                        catch (Exception e)
